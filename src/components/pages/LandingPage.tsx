  ...
  return (
    <>
      <Grid2 container spacing={4}>
        ...
        >
          <Typography variant="h1" gutterBottom sx={{fontSize: {xs: ".8rem", sm: "1rem"}}}>Employee Management</Typography>
          <Box
            component="img"
            sx={{
        ...
        <Grid2 size={{ xs: 12, sm: 12, md: 5, lg: 5 }} sx={{display: "flex", flexDirection: "column", alignItems:"center", justifyContent: "center"}}>
